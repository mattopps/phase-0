...
//    - deleting the eyecolor. I thought I could use .delete. Thought there was an example of that in a chapter. Instead I just reassigned it to undefined, but I kept a stray ) at the end. 


// How difficult was it to add and delete properties outside of the object itself?

//      -not tough in this particular challenge

// What did you learn about manipulating objects in this challenge?
//    -I learned that it is deceptively straightforward to add new propertied to an object , or change them. with the caveat that I didn't delete the eyecolor property entirely but merely changed it to undefined.
//     It is straightforward in this context to simply add or modify values. 
