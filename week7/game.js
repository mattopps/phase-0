...
var war = function(){
 			console.log("WAAAAAAAAAAAAAAARRRRRR!!!!!!!!");
...
//		- Here is a biggie - forgetting empty parens after functions without parameters. sometimes .shift,pop etc I would just write the word without the paren. took me a loooong time to find it. Then again If I was more familiar with the error raising in JS it would be obvious(if I was remembering to print every line as a test), because it printed "Function: Shift"  soooo hindsight ...
